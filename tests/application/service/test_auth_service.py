...
class TestSendWelcomeMail:
    def test_send_welcome_mail(self, mocker):
        ...
        mock_render_template = mocker.patch(
            'app.application.service.auth_service.render_template',
            return_value='<html>Welcome!</html>',
        )
        mock_send_task = mocker.patch('app.application.service.auth_service.send_mail_task')
        mock_mail = mocker.patch('app.application.service.auth_service.Mail')
